...
func _physics_process(delta):
	...
	if Input.is_action_just_released("ui_left") && animation.current_animation != "lean_right":
		animation.play_backwards("lean_left")
	
	if Input.is_action_just_pressed("ui_right"):
		animation.play("lean_right")
	
	if Input.is_action_just_released("ui_right") && animation.current_animation != "lean_left":
		animation.play_backwards("lean_right")
	...
	if Input.is_action_just_pressed("peek_left"):
		animation.play("peek_left")
	
	if Input.is_action_just_released("peek_left") && animation.current_animation != "peek_right":
		animation.play_backwards("peek_left")
		
	if Input.is_action_just_pressed("peek_right"):
		animation.play("peek_right")
	
	if Input.is_action_just_released("peek_right") && animation.current_animation != "peek_left":
		animation.play_backwards("peek_right")
